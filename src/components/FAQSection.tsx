...
const faqItems = {
  he: [
    ...
    },
    {
      ...
      a: 'זה השילוב שמעניק לכם פתרון שלם ומנצח. הלהקה מספקת מענה חי, מרגש ואותנטי ברגעים המרגשים של תחילת הערב. מיד לאחר מכן, ה-DJ שלנו נכנס לעמדה כדי להרים את האנרגיה למקסימום. אתם נהנים מכל העולמות – לייב מרגש בהתחלה, ומסיבת DJ מדויקת ומקפיצה בהמשך.',
    },
    {
    ...
    },
    {
      ...
      a: "אנחנו מגיעים לכל מקום שבו יש רחבה להעיף אתכם, גם בחו״ל!",
    },
  ],
  en: [
    {
  ...
  return (
    <section id="faq" className="section-padding bg-muted/30">
      <div ref={ref} className={`max-w-3xl mx-auto ${isVisible ? "" : "opacity-0"}`}>
        ...
        <Accordion type="single" collapsible className={`space-y-2 transition-all duration-700 ${isVisible ? "animate-fade-up" : ""}`} style={{ animationDelay: "200ms" }}>
