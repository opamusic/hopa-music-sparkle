...
const Footer = () => (
  <footer className="bg-muted/50 py-12 px-6">
    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
      <img src={logoBlack} alt="הופה מוזיקה" className="h-8 opacity-60" />
      ...
      <div className="text-center md:text-left text-sm text-muted-foreground font-body space-y-1">
        <p>© {new Date().getFullYear()} הופה מוזיקה. כל הזכויות שמורות.</p>
        <p><a href="#" className="hover:text-primary transition-colors">הצהרת נגישות</a></p>
      </div>
    </div>
  </footer>
);
